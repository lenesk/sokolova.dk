...
The challenge for learning to phrase a complex and correct sentence, is that many learners are already quite fluent to the level B1 like module 3 at DU3 for example. And many incorrect structures are automated. It happens due to many factors. E.g., many language courses and books are based on the method of learning Danish via communicative approach, so it focuses on speaking without much analyzing what happens in a phrase in terms of functional grammar which is a good supplement for the communicative method: e.g. how to logically connect the utterances in terms of contrast, explanation, cause and result (a common confusing in learners). 

Some learners may feel stuck at level B1, and try several attempts passing writing at module 4, drop out of module 4 at DU3 and then try to pass PD3 on their own. All because of a missing control to express themselves in a more complex way, when a common language production is focused around describing. Describing is what you learn at level A1 & A2. But expressing attitude to something at level B1 and B2 requires complexity. 

So to pass the B2 (PD3) level exam you need to show a certain complexity of the language, it's simply one of the assessment criteria. Therefore passing PD2 does not automatically mean that you can pass PD3 after some months of reading on previous exam papers for PD3, it is not at least common that such a strategy will work. A similar problem may arise when learners pass PD3, but not with the grades they want, because to pass PD3 with 7, 10 or even 12 as grades, you need to show even more complexity and detailed perceptive understanding of complex language (e.g. in reading and listening), as well as actively to produce it (in speaking and writing).
